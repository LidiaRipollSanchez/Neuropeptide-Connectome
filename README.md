...
The adjancency matrices in the Adjacency matrices for networks folder were updated on 02/02/2024 with new scRNAseq data from CeNGEN (there were problems in the expression of dmsr-5 and npr-34).
